  ...
  public register() {
    ...
    if (this.setUserName === "" || this.setEmail === "" || this.setPassword === "" || this.setConfirmPassword === "" || this.setMobileNumber === "") {
      ...
      this.error="Your Mobile Number Should Be 10 Numbers"
        ...
        model.phoneNumber = this.setMobileNumber
        ...
        var checkedExsitingphonenumber=intedervalues.findIndex((checkMobileNumber:any)=>checkMobileNumber.phoneNumber === this.setMobileNumber);
        
        console.log("checkedExsitingUser", checkedExsitingUser)
        console.log("checkedExsitingphonenumber", checkedExsitingphonenumber)

        if(checkedExsitingUser>=0) {
          this.error = "EmailId Was Already Exist"
        } else if(checkedExsitingphonenumber>=0){
          this.error = "mobileNumber Was Already Exist"
        } else if (checkedExsitingUser === this.negativOne) {
